...
func privateChannelInfo(ctx context.Context, client *telegram.Client, hash string) (id int64, aHash int64, err error) {
...
func publicChannelInfo(ctx context.Context, client *telegram.Client, name string) (id, accessHash int64, err error) {

...
type BaseShareFile struct {
	...
	ImageMediaMetadata   string   `json:"image_media_metadata"`
	VideoMediaMetadata   string   `json:"video_media_metadata"`
	VideoPreviewMetadata string   `json:"video_preview_metadata"`
